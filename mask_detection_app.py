    ...
    try:
        while True:
            ...
            a,b=detector_utils.draw_box_on_image(
                num_faces_detect, score_thresh, scores, boxes, classes, im_width, im_height, frame,0,Orientation)
            lst1.append(a)
            lst2.append(b)
        ...
        #no_of_time_face_detected=b
        no_of_time_face_crossed=count_no_of_times(lst1)
        #print(no_of_time_face_detected)
        #print(no_of_time_face_crossed)
        #save_data(no_of_time_face_detected, no_of_time_face_crossed)
